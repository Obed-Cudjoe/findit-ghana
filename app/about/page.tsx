...
export default function AboutPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-10">
      <header>
        <h1 className="text-3xl font-extrabold text-navy-900 dark:text-navy-100">Why we built this</h1>
      </header>

      <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-slate-soft dark:text-navy-300">
        <p>
        ...
        <p>
          We built <strong className="text-navy-900 dark:text-navy-100">FindIt Ghana</strong> to put every honest answer on one page: real prices in cedis, live stock,
      ...
      <h2 className="mt-10 text-xl font-extrabold text-navy-900 dark:text-navy-100">What we believe</h2>
      <ul className="mt-4 space-y-3 text-sm text-slate-soft dark:text-navy-300">
        <li className="flex gap-3"><Flag className="h-5 w-5 shrink-0 text-gold-600 dark:text-gold-500" /> Prices in cedis — never dollars, never &apos;ask&apos;.</li>
        <li className="flex gap-3"><Flag className="h-5 w-5 shrink-0 text-gold-600 dark:text-gold-500" /> Named vendors only — anonymity is how scams hide.</li>
        <li className="flex gap-3"><Flag className="h-5 w-5 shrink-0 text-gold-600 dark:text-gold-500" /> No surprises at delivery — the total is on the table first.</li>
      </ul>

      <h2 className="mt-10 text-xl font-extrabold text-navy-900 dark:text-navy-100">The founder</h2>
      <p className="mt-2 text-sm text-slate-soft dark:text-navy-300">
        Built by Obed Cudjoe — a one-person operation in Accra, obsessed with honest prices. <HeartHandshake className="inline h-4 w-4 text-gold-600 dark:text-gold-500" aria-hidden="true" /> I started
      ...
      <p className="mt-3 text-sm">
        <a href="https://www.linkedin.com/in/obed-cudjoe" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 font-semibold text-navy-700 dark:text-navy-300 underline hover:text-gold-700">
