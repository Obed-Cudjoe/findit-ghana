...
export function Editor({ guides }: { guides: GuideInput[] }) {
  ...
  if (guides.length === 0) {
    return <p className="text-sm text-slate-soft">No guides available.</p>;
  }
    ...
    <div className="grid gap-6 lg:grid-cols-[260px_1fr]">
      ...
      <div className="space-y-4 rounded-xl border border-navy-100 bg-white p-5">
        ...
        <div className="flex items-center gap-3">
          ...
          {saved && <span className="text-sm font-semibold text-emerald-700">Saved ✓ (goes live on the next refresh — instant once Supabase is connected)</span>}
