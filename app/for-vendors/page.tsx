  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-10">
      <header className="max-w-2xl">
        ...
        <h1 className="mt-2 text-2xl font-extrabold text-navy-900 sm:text-3xl">Put your shop in front of Ghanaian shoppers</h1>
        <p className="mt-3 text-sm leading-relaxed text-slate-soft">
          ...
          It takes two steps: <strong className="text-navy-900">1)</strong> register your shop here and pick a plan, then{" "}
          <strong className="text-navy-900">2)</strong> log in to your dashboard and list your products with photos.
      ...
      <div className="mt-10 grid gap-8 lg:grid-cols-[1fr_320px]">
        <div className="rounded-2xl border border-navy-100 bg-white p-4 shadow-sm sm:p-6">
          <h2 className="flex items-center gap-2 text-lg font-extrabold text-navy-900">
            <Store className="h-5 w-5 text-gold-600" /> Register your shop
          </h2>
        ...
        <aside className="space-y-4">
          <div className="rounded-xl border border-navy-100 bg-navy-50/70 p-5">
            ...
            <ol className="mt-3 space-y-2 text-sm text-slate-soft">
              <li><span className="font-bold text-navy-900">1.</span> Your shop enters our review queue.</li>
              <li><span className="font-bold text-navy-900">2.</span> Paid plans: send MoMo to {MOMO_NUMBER} ({MOMO_NAME}), then WhatsApp the reference.</li>
              <li><span className="font-bold text-navy-900">3.</span> Sign in at <Link className="font-semibold text-navy-800 underline" href="/vendor/login">/vendor</Link> and add your products — at least 3 photos each. Each one goes to review before it appears in search.</li>
              <li><span className="font-bold text-navy-900">4.</span> Once approved, your shop appears on <Link className="font-semibold text-navy-800 underline" href="/vendors">/vendors</Link>.</li>
            </ol>
          </div>
          <div className="rounded-xl border border-navy-100 bg-white p-5 text-sm text-slate-soft">
            <h2 className="font-bold text-navy-900">Already registered?</h2>
            <p className="mt-2">
              Sign in at{" "}
